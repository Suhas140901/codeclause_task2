...
canvas = tk.Tk()
canvas.title("Music Player with Python")
canvas.geometry("600x800")
canvas.config(bg = 'white')

rootpath = "D:\\Internship\code clause\songs"
pattern = "*.mp3"
...
listbox = tk.Listbox(canvas, fg ="black", bg = "lightblue", width=100, font = ('ds-digital', 14))
listbox.pack(padx = 15, pady = 15)

"""listbox.insert(0, "coding")
listbox.insert(1, "with")
listbox.insert(2, "even")"""
